...
mixin _$GenericPoint<TX, TY> {
  ...
  $GenericPointCopyWith<TX, TY, GenericPoint<TX, TY>> get copyWith =>
      _$GenericPointCopyWithImpl<TX, TY, GenericPoint<TX, TY>>(
          this as GenericPoint<TX, TY>, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GenericPoint<TX, TY> &&
...
abstract mixin class $GenericPointCopyWith<TX, TY, $Res> {
  factory $GenericPointCopyWith(GenericPoint<TX, TY> value,
      $Res Function(GenericPoint<TX, TY>) _then) = _$GenericPointCopyWithImpl;
  @useResult
  $Res call({TX x, TY y});
}
