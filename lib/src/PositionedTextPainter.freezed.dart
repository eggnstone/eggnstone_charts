...
mixin _$PositionedTextPainter {
  ...
  $PositionedTextPainterCopyWith<PositionedTextPainter> get copyWith =>
      _$PositionedTextPainterCopyWithImpl<PositionedTextPainter>(
          this as PositionedTextPainter, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PositionedTextPainter &&
...
abstract mixin class $PositionedTextPainterCopyWith<$Res> {
  factory $PositionedTextPainterCopyWith(PositionedTextPainter value,
          $Res Function(PositionedTextPainter) _then) =
...
class _PositionedTextPainter implements PositionedTextPainter {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PositionedTextPainterCopyWith<_PositionedTextPainter> get copyWith =>
      __$PositionedTextPainterCopyWithImpl<_PositionedTextPainter>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PositionedTextPainter &&
            (identical(other.position, position) ||
                other.position == position) &&
            (identical(other.textPainter, textPainter) ||
                other.textPainter == textPainter));
...
/// @nodoc
abstract mixin class _$PositionedTextPainterCopyWith<$Res>
    implements $PositionedTextPainterCopyWith<$Res> {
  factory _$PositionedTextPainterCopyWith(_PositionedTextPainter value,
          $Res Function(_PositionedTextPainter) _then) =
